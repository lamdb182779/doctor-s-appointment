...
const StaffInfo = (props) => {
    ...
    useEffect(() => {
        setUrl(`http://localhost:8080/api/staffs/${id}/${change}`)
    ...
    return (
        <div className="staff-info-container px-5 py-5 d-grid gap-5">
            <Success
                show={showSuccess}
                        ...
                        <>
                            <Row className="">
                                <Col xs={2} className="d-flex justify-content-start">
                                    <Button onClick={() => navigate('/admin/staff-list')} variant="outline-secondary" size="sm">Quay lại</Button>
                                </Col>
                            </Row>
                            <Row className="fs-6 text-start d-flex align-items-center">
                                <Col xs={4}>
                                    <OverlayTrigger
                                        ...
                                        <Image onClick={(event) => event.target.click()} className="w-50 h-auto" src={data[0].image ? data[0].image : nullavatar} alt='avatar' roundedCircle />
                                    </OverlayTrigger>
                                </Col>
                                <Col>
                                    <Row>
                                    ...
                                    <Row>
                                        <Col>
                                            <b>Giới tính: </b>
                                            {data[0].gender === true && "Nam"}{data[0].gender === false && "Nữ"}
                                        </Col>
                                    </Row>
                                </Col>
                            </Row>
                            ...
                            <OverlayTrigger
                                ...
                                <div onClick={() => handleShow()} className="staff-info-to-change d-flex justify-content-center align-items-center">
